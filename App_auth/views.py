...
from App_admin.views import is_customer, is_admin, is_service_man
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if user:
                ...
                elif is_service_man(user):
                    return HttpResponseRedirect(reverse('App_main:service-man-dashboard'))

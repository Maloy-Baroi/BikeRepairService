...
urlpatterns = [
    ...
    path('service-man-dashboard/', views.service_man_dashboard, name='service-man-dashboard'),
    path('invoice-view/', views.invoice_view, name='invoice-view'),
    path('single-invoice-view/<int:pk>/', views.single_invoice_view, name='single-invoice-view'),
]
